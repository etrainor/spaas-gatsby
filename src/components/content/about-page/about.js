...
function About () {
  return (
    <div className="about-us">
      ...
      <p>Over time, our children have attended a variety of different schools and we have learned that approaches towards IEPs and the ability to provide accommdations can vary greatly between schools and districts. While private schools may have smaller class sizes they generally completely lack or have limited services and find it harder to either implement or follow through with accommodations. Whether public or private your child deserves the chance to not just survive but thrive in their classroom.</p>

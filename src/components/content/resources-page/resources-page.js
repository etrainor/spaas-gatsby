      ...
      <div className="resources-page">
        ...
        <div className="books">
          <div className = "book-container">
            ...
            <p className="description">It all seems very simple. A special education law, the Individuals with Disabilities Education Act (IDEA), was enacted by Congress in 1975 to ensure that children with disabilities have the opportunity to receive a free appropriate public education, just like other children. But nothing is ever simple...</p>
          ...
          <div className = "book-container">
            ...
            <p className="description">Gary Mayerson has devoted his career in law to helping children with autism get the fair and appropriate education that they need and deserve. In this field guide, he brings parents up to speed quickly and efficiently on the ways educational bureaucracies workor more importantly, don't for children with special needs...</p>
        ...
        <div className="outside-links">
          <ul> Seattle Times - Education Lab
            <li><a href="https://www.seattletimes.com/education-lab/for-some-washington-students-with-special-needs-diagnosis-comes-too-late/" target="_blank">For some Washington Students with special needs, diagnosis is too late, help is too little</a> <br/><p className="attribution">- By: Katherine Long, July 9, 2019</p></li>
            <li><a href="https://www.seattletimes.com/education-lab/why-washington-is-suddenly-paying-more-attention-to-its-25500-paraeducators/" target="_blank">‘Basically I’m their teacher’: Washington has big plans for its 25,500 school paraeducators</a> <br/><p className="attribution">- By: Neal Morton, July 28, 2019</p></li>
            <li><a href="https://www.seattletimes.com/education-lab/students-with-dyslexia-struggle-in-washington-will-a-fresh-approach-to-reading-instruction-be-enough/" target="_blank">Students with dyslexia struggle in Washington. Will a fresh approach to reading instruction be enough?</a> <br/><p className="attribution">- By: Katherine Long, July 8, 2019</p></li>
            <li><a href="https://www.seattletimes.com/education-lab/special-education-can-be-confusing-here-are-terms-and-programs-you-should-know/" target="_blank">Special education can be confusing. Here are terms and programs you should know.</a> <br/><p className="attribution">- By: Mohammed Kloub, May 24, 2019</p></li>
          </ul>
          <ul> Education Week
            <li><a href="https://www.edweek.org/ew/articles/2019/05/08/students-with-disabilities-deserve-inclusion-its-also.html" target="_blank">Students With Disabilities Deserve Inclusion. It's Also the Best Way to Teach</a> <br/><p className="attribution">- By: Hannah Grieco, May 7, 2019</p></li>
          </ul>
        </div>
      </div>
    </>
